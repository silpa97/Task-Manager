                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-login">Login user</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-assign-role">
                                <a href="#endpoints-POSTapi-assign-role">Assign a role to a user</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-projects">Create a new project</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-projects--id-">
                                <a href="#endpoints-GETapi-projects--id-">Show a single project</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-projects--id-">
                                <a href="#endpoints-PUTapi-projects--id-">Update a project</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-projects--id-">
                                <a href="#endpoints-DELETEapi-projects--id-">Delete a project</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-tasks">
                                <a href="#endpoints-GETapi-tasks">Display a list of tasks</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-tasks--id-">Show a single task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-tasks--id-">
                                <a href="#endpoints-PUTapi-tasks--id-">Update a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-tasks--id-">
                                <a href="#endpoints-DELETEapi-tasks--id-">Delete a task</a>
                            </li>
...
<p>Creates a user with name, email, and password. By default, no role is assigned. Must be assigned later by an admin.</p>
...
<p>Logs in a user and returns a bearer token on success.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email of the user. Example: <code>john@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Password of the user. Example: <code>secret123</code></p>
        </div>
        </form>

                    <h2 id="endpoints-POSTapi-assign-role">Assign a role to a user</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Only admins can assign roles to other users like project manager, team lead, or developer.</p>

<span id="example-requests-POSTapi-assign-role">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/assign-role" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"user_id\": 2,
...
<span id="example-responses-POSTapi-assign-role">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-assign-role" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-assign-role"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-assign-role"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-assign-role" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-assign-role">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-assign-role" data-method="POST"
      data-path="api/assign-role"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-assign-role', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-assign-role"
                    onclick="tryItOut('POSTapi-assign-role');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-assign-role"
                    onclick="cancelTryOut('POSTapi-assign-role');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-assign-role"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-assign-role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-assign-role"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="user_id"                data-endpoint="POSTapi-assign-role"
               value="2"
               data-component="body">
    <br>
<p>The ID of the user to assign a role to. Example: <code>2</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="POSTapi-assign-role"
               value="project_manager"
               data-component="body">
    <br>
<p>The role to assign. Allowed values: admin, project_manager, team_lead, developer. Example: <code>project_manager</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-projects">Create a new project</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Only project managers can assign projects to team leads.</p>
...
<i>optional</i> &nbsp;
               ...
               value="Redesign UI/UX for the landing page."
               data-component="body">
    <br>
<p>The description of the project. Example: <code>Redesign UI/UX for the landing page.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="assigned_to"                data-endpoint="POSTapi-projects"
               value="3"
               data-component="body">
    <br>
<p>The user ID of the team lead. Example: <code>3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>date</small>&nbsp;
 &nbsp;
               ...
               value="2025-09-23 18:30:44"
               data-component="body">
    <br>
<p>The deadline for the project. Example: <code>2025-09-23 18:30:44</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-projects--id-">Show a single project</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns detailed information about a specific project including its assigned team lead.</p>
...
<p>The ID of the project. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-projects--id-">Update a project</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Allows a project manager to update project details like title, description, end date, or assigned team lead.</p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the project to update. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>title</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
               ...
               value="Revamp Website UI"
               data-component="body">
    <br>
<p>The updated title of the project. Example: <code>Revamp Website UI</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               value="Add animations and new design elements."
               data-component="body">
    <br>
<p>The updated description of the project. Example: <code>Add animations and new design elements.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>assigned_to</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="assigned_to"                data-endpoint="PUTapi-projects--id-"
               value="3"
               data-component="body">
    <br>
<p>The ID of the team lead to assign the project to. Example: <code>3</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>end_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The new project deadline. Example: <code>2025-09-25</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-projects--id-">Delete a project</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Allows a project manager to delete a specific project.</p>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the project to delete. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-tasks">Display a list of tasks</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Developers see tasks assigned to them. Team leads see tasks they assigned.</p>
...
<p>Only team leads can assign tasks within their own projects.</p>
...
<i>optional</i> &nbsp;
               ...
               value="Include hero section"
               data-component="body">
    <br>
<p>Optional description of the task. Example: <code>Include hero section</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>ID of the project. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>assigned_to</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Developer's user ID. Example: <code>5</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>due_time</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="due_time"                data-endpoint="POSTapi-tasks"
               value="2025-08-10"
               data-component="body">
    <br>
<p>Deadline for the task. Must be today or later. Example: <code>2025-08-10</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-tasks--id-">Show a single task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns the details of a specific task.</p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="task"                data-endpoint="GETapi-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-tasks--id-">Update a task</h2>
...
<ul>
<li>Team leads can update title, description, deadline, and status.</li>
<li>Developers can update only task status.</li>
</ul>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The updated task title. Example: <code>Fix login</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               value="Resolve session timeout issue"
               data-component="body">
    <br>
<p>The updated task description. Example: <code>Resolve session timeout issue</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="deadline"                data-endpoint="PUTapi-tasks--id-"
               value="2025-08-20"
               data-component="body">
    <br>
<p>The new due date. Example: <code>2025-08-20</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Status of the task. Must be one of: pending, in_progress, completed. Example: <code>in_progress</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-tasks--id-">Delete a task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Only team leads can delete tasks they created.</p>
...
<p>Revokes the current access token for the logged-in user.</p>
